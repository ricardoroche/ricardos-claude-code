...
Defines a hybrid-pattern subagent that authors OpenSpec materials and core documentation (design docs, ADRs, READMEs, changelogs) using dedicated documentation skills and OpenSpec conventions.
