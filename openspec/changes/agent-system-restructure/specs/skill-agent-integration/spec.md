...
**Then** it MUST list agents in "Agent Integration" section

**And**:
**Given** an agent uses multiple skills
**When** agent file is created
**Then** it MUST list skills in "Skills Integration" section
...
Agent workflows SHOULD use these patterns to trigger skills:
...
Workflows SHOULD use natural language that implies technology/patterns.
